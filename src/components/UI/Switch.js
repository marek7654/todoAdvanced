...
const Switch = (props) => {
  ...
  return (
    <div className={`${classes.switch_wrapper} ${absolute && classes.absolute}`}>
      {labelLeft && <span className={classes.span_left}>{labelLeft}</span>}
      <label className={classes.switch}>
        <input className={classes.checkbox} type='checkbox' checked={value} onChange={props.onSwitchChange} />
